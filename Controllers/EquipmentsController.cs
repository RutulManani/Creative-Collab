...
namespace EduFitMart.Controllers
{
    public class EquipmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EquipmentId,Name,Description")] Equipment equipment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EquipmentId,Name,Description")] Equipment equipment)
        {
